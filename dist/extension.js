...
// src/utils/project-path-finder.js
var require_project_path_finder = __commonJS({
  "src/utils/project-path-finder.js"(exports2, module2) {
    var vscode2 = require("vscode");
    var path = require("path");
    var cachedPath = null;
    var ProjectMainPath = class {
      ...
      static async testPath(folderPath) {
        ...
        return this.testPath(parentFolder);
      }
      ...
      static async _fileExists(filePath) {
        try {
          return vscode2.workspace.fs.stat(vscode2.Uri.file(filePath)).then(() => true, () => false);
        } catch {
          return false;
        }
      }
    };
    module2.exports = ProjectMainPath;
  }
});

// src/utils/path-provider.js
var require_path_provider = __commonJS({
  "src/utils/path-provider.js"(exports2, module2) {
    var path = require("path");
    var vscode2 = require("vscode");
    var ProjectMainPath = require_project_path_finder();
    var pubspecpath;
    var projectpath;
    var manifestpath;
    var libpath;
    async function findPaths2() {
      ...
      manifestpath = projectpath ? path.join(
        projectpath,
        "android",
        "app",
        "src",
    ...
    async function fileStat(filePath) {
      return await vscode2.workspace.fs.stat(vscode2.Uri.file(filePath));
    }
    async function fileExists(filePath) {
      try {
        ...
        if (err instanceof vscode2.FileSystemError && err.code === "FileNotFound") {
          return false;
        }
        throw err;
      }
    }
    module2.exports = { fileExists, fileStat, findPaths: findPaths2, pubspecPath, projectPath, libPath, manifestPath };
  }
});

// src/services/dart-sdk-finder.js
var require_dart_sdk_finder = __commonJS({
  "src/services/dart-sdk-finder.js"(exports2, module2) {
    var path = require("path");
    var exec = require("child_process").exec;
    var vscode2 = require("vscode");
    var { fileExists } = require_path_provider();
    ...
    var SdkFinder = class {
      ...
      async detectSdkFromVscode() {
        const dartSdkFromVscode = vscode2.workspace.getConfiguration().get("dart.sdkPath");
        const flutterSdkFromVscode = vscode2.workspace.getConfiguration().get("flutter.sdkPath");
      ...
      async normalizeDartSdkPath(sdkPath) {
        ...
        const singleBinPath = sdkPath.split(/\r?\n/).map((line) => line.trim()).sort((a, b) => {
    ...
    module2.exports = SdkFinder;
  }
});

// src/services/file-analyzer.js
var require_file_analyzer = __commonJS({
  "src/services/file-analyzer.js"(exports2, module2) {
    var path = require("path");
    var vscode2 = require("vscode");
    var { libPath, fileStat } = require_path_provider();
    var FileAnalyzer = class _FileAnalyzer {
      ...
      static getInstance() {
        if (!this.instance) {
          this.instance = new _FileAnalyzer();
        }
        return this.instance;
      }
      async analyzeProjectFiles(projectPath) {
        const isFile = (statType) => statType === vscode2.FileType.File;
        const isDirectory = (statType) => statType === vscode2.FileType.Directory;
        ...
        if (isFile(stat.type) && projectPath.endsWith(".dart")) {
          ...
          const files = await vscode2.workspace.fs.readDirectory(
      ...
      async checkLibPath(projectPath) {
        ...
        if (projectPath.startsWith(libPath())) {
          return true;
        }
      }
      rejectFile(filePath) {
      ...
      async analyzeFile(filePath) {
        try {
          ...
          const uint8Content = await vscode2.workspace.fs.readFile(vscode2.Uri.file(filePath));
          ...
          vscode2.window.showInformationMessage("Analyzing Eror path: " + filePath);
        }
      }
    };
    module2.exports = FileAnalyzer;
  }
});

// src/services/dart-analysis-server.js
var require_dart_analysis_server = __commonJS({
  "src/services/dart-analysis-server.js"(exports2, module2) {
    var { spawn } = require("child_process");
    var DartAnalysisServer = class _DartAnalysisServer {
      constructor() {
      ...
      static getInstance() {
        if (!this.instance) {
          this.instance = new _DartAnalysisServer();
        }
        return this.instance;
      }
    ...
    var serverNotStartedMessage = "Analysis server not started";
    var fileNotAnalyzed = "FILE_NOT_ANALYZED";
    module2.exports = {
      DartAnalysisServer,
...
// src/services/dart-analyzer.js
var require_dart_analyzer = __commonJS({
  "src/services/dart-analyzer.js"(exports2, module2) {
    var vscode2 = require("vscode");
    var SdkFinder = require_dart_sdk_finder();
    var FileAnalyzer = require_file_analyzer();
    var { DartAnalysisServer } = require_dart_analysis_server();
    var { libPath } = require_path_provider();
    var { assert } = require("console");
    var DartAnalyzer2 = class _DartAnalyzer {
      constructor() {
        this.analyzedProjectFiles = /* @__PURE__ */ new Set();
        this.config = vscode2.workspace.getConfiguration("widgetedit");
      ...
      static getInstance() {
        if (!this.instance) {
          this.instance = new _DartAnalyzer();
        }
        return this.instance;
      }
      async start() {
        if (this.analysisServer.isRunning()) {
          return;
        }
        ...
        if (!dartSdkPath || !analyzerSnapshotPath) {
          vscode2.window.showErrorMessage("Dart SDK or analysis server snapshot not found.");
          return;
        }
        ...
        vscode2.window.showInformationMessage("analyzer server started\n");
        if (!this.analysisServer) {
          vscode2.window.showErrorMessage("cant start server");
          return;
        }
      ...
      registerSwitchCommands(context) {
        const start = vscode2.commands.registerCommand(
          "analysisserver.start",
          async () => {
            _DartAnalyzer.serverMustStop = false;
            await this.start();
            this.switchStartStopServerTag();
            setTimeout(
              () => vscode2.window.showWarningMessage(
                "To use Widget Properties please reopen any doc you want to edit."
              ),
              1e3
            );
          }
        );
        const stop = vscode2.commands.registerCommand(
          "analysisserver.stop",
          async () => {
            _DartAnalyzer.serverMustStop = true;
            this.stop();
            this.switchStartStopServerTag();
          }
        );
      ...
      stop() {
        vscode2.window.showInformationMessage("analyzer server will stop\n");
        this.analysisServer.stop();
      }
    };
    module2.exports = DartAnalyzer2;
  }
});

// src/create-workspace/workspace-json-creater.js
var require_workspace_json_creater = __commonJS({
  "src/create-workspace/workspace-json-creater.js"(exports2, module2) {
    var WorkspaceJsonCreater = class {
    ...
    module2.exports = WorkspaceJsonCreater;
  }
});

// src/create-workspace/workspace-command.js
var require_workspace_command = __commonJS({
  "src/create-workspace/workspace-command.js"(exports2, module2) {
    var path = require("path");
    var vscode2 = require("vscode");
    var WorkspaceJsonCreater = require_workspace_json_creater();
    var { projectPath } = require_path_provider();
    var platforms = ["Android", "iOS", "macOS", "Linux", "Web", "Windows"];
    var WorkspaceCommand = class {
      static async createAndApply() {
        const projPath = projectPath();
        if (!projPath) {
          vscode2.window.showErrorMessage("No folder is opened in VS Code!");
          return;
        }
        const projectName = path.basename(projPath);
        const workspaceFileName = `${projectName}.code-workspace`;
        const selectedPlatform = await vscode2.window.showQuickPick(platforms, {
          placeHolder: "Select the platform for your project"
        });
        if (!selectedPlatform) {
          vscode2.window.showErrorMessage("No platform selected!");
          return;
        }
        let platformFolders = WorkspaceJsonCreater.getPlatformFolders(selectedPlatform);
        const baseFolders = [
          {
            name: "Source Code",
            path: "../lib"
        ...
        await vscode2.workspace.fs.writeFile(
          vscode2.Uri.file(workspaceFilePath),
          encoder.encode(content)
        );
        const uri = vscode2.Uri.file(workspaceFilePath);
        await vscode2.commands.executeCommand("vscode.openFolder", uri, false);
      }
    };
    module2.exports = WorkspaceCommand;
  }
});

// src/command-manager.js
var require_command_manager = __commonJS({
  "src/command-manager.js"(exports2, module2) {
    var vscode2 = require("vscode");
    var WorkspaceCommand = require_workspace_command();
    var CommandManager2 = class {
      constructor(context) {
        this.context = context;
      }
      registerCommands() {
        const perabi = vscode2.commands.registerCommand(
          "flutter.per.abi",
          this.flutterPerAbi
        );
        const adddependency = vscode2.commands.registerCommand(
          "dependencies.add",
          this.addDependency
        );
        const createAndApply = vscode2.commands.registerCommand(
          "flutter.createWorkspace",
          WorkspaceCommand.createAndApply
        );
      ...
      addDependency() {
        vscode2.commands.executeCommand("dart.addDependency");
      }
      flutterPerAbi() {
...
// src/utils/webview-validator.js
var webview_validator_exports = {};
__export(webview_validator_exports, {
  getNonce: () => getNonce,
  setOnDidChangeVisibility: () => setOnDidChangeVisibility
});
function getNonce() {
  let text = "";
...
var init_webview_validator = __esm({
  "src/utils/webview-validator.js"() {
  }
});

// src/dependency-edit/dependency-html.js
var require_dependency_html = __commonJS({
  "src/dependency-edit/dependency-html.js"(exports2, module2) {
    var { getNonce: getNonce2 } = (init_webview_validator(), __toCommonJS(webview_validator_exports));
    var DependencyWebViewHtml = class {
      static generate(dependencies) {
        ...
        const rows = dependencies.map((dep) => {
          ...
          const subRows = dep.subDependencies ? Object.entries(dep.subDependencies).map(
            ([key, value]) => `<tr class="subdependency-row">
    ...
    module2.exports = DependencyWebViewHtml;
  }
});

// src/dependency-edit/dependency-provider.js
var require_dependency_provider = __commonJS({
  "src/dependency-edit/dependency-provider.js"(exports2, module2) {
    var vscode2 = require("vscode");
    var DependencyWebViewHtml = require_dependency_html();
    var { setOnDidChangeVisibility: setOnDidChangeVisibility2 } = (init_webview_validator(), __toCommonJS(webview_validator_exports));
    var commands = {
      refresh: "refresh",
      add: "addDependency",
    ...
    var DependencyProvider = class {
      ...
      resolveWebviewView(webviewView) {
        ...
        setOnDidChangeVisibility2(webviewView, () => this.dispose());
      }
      dispose() {
        this._view?.dispose();
      }
      ...
      addDependency() {
        vscode2.commands.executeCommand("dart.addDependency").then(() => this.updateWebviewContent());
      }
      removeDependency(dependencyName) {
        const index = this.dependencies.findIndex((dep) => dep.name === dependencyName);
        if (index === -1) {
          vscode2.window.showErrorMessage(`Dependency "${dependencyName}" not found.`);
          return;
        }
        this.dependencies.splice(index, 1);
        const pubspec = this.pubspecManager.readPubspec();
        if (!pubspec || !pubspec.dependencies) {
          vscode2.window.showErrorMessage("Failed to load pubspec.yaml.");
          return;
        }
        ...
        vscode2.window.showInformationMessage(`Removed dependency "${dependencyName}".`);
      }
      refresh(dependency) {
        const pubspec = this.pubspecManager.readPubspec();
        if (!pubspec) {
      ...
      updateDependency() {
        vscode2.commands.executeCommand("flutter.packages.upgrade");
      }
      listOutdatedDependencies() {
        vscode2.commands.executeCommand("flutter.packages.outdated");
      }
    };
    module2.exports = DependencyProvider;
  }
});
...
// src/dependency-edit/dependency-service.js
var require_dependency_service = __commonJS({
  "src/dependency-edit/dependency-service.js"(exports2, module2) {
    ...
    module2.exports = DependencyService;
  }
});
...
// src/permission-edit/manifest-service.js
var require_manifest_service = __commonJS({
  "src/permission-edit/manifest-service.js"(exports2, module2) {
    var vscode2 = require("vscode");
    var { DOMParser } = require_lib3();
    var { manifestPath, fileExists } = require_path_provider();
    var ManifestService = class {
      async readPermissions() {
        ...
        const decoder = new TextDecoder("utf-8");
        const uint8Content = await vscode2.workspace.fs.readFile(vscode2.Uri.file(manifestPath()));
      ...
      async addPermission(permission) {
        ...
        if (content.includes(permission)) {
          vscode2.window.showWarningMessage("Permission already exists.");
          return;
        }
...
`;
        ...
        const encoder = new TextEncoder();
        await vscode2.workspace.fs.writeFile(
          vscode2.Uri.file(manifestPath()),
          encoder.encode(content)
        );
        vscode2.window.showInformationMessage(`Added permission: ${permission}`);
      }
      async removePermission(permission) {
        ...
        if (!regex.test(content)) {
          vscode2.window.showWarningMessage("Permission not found.");
          return;
        }
        ...
        vscode2.window.showInformationMessage(`Removed permission: ${permission}`);
      }
      async isValidPath() {
        const path = manifestPath();
        const existingManifest = path.trim() !== "" && await fileExists(path);
        if (!existingManifest) {
          if (vscode2.workspace.workspaceFolders?.length > 0) {
            vscode2.window.showErrorMessage("AndroidManifest.xml not found.");
          }
          return false;
        }
        return true;
    ...
    module2.exports = ManifestService;
  }
});

// src/permission-edit/permission-list.js
var require_permission_list = __commonJS({
  "src/permission-edit/permission-list.js"(exports2, module2) {
    ...
    function getPermissionsMap() {
      const permissionsMap = {
        ...
        "BILLING_INTERNAL": "com.android.vending.BILLING_INTERNAL",
        // Google Cloud Messaging
        "C2D_MESSAGE": "com.google.android.c2dm.permission.C2D_MESSAGE",
        "RECEIVE": "com.google.android.c2dm.permission.RECEIVE",
        // In-App Updates
        "UPDATE_APP": "com.google.android.play.store.permission.UPDATE_APP",
        // Firebase
        "RECEIVE_BOOT_COMPLETED_FIREBASE": "com.google.android.gms.permission.RECEIVE_BOOT_COMPLETED",
        // Common third-party permissions
    ...
    module2.exports = { getPermissionsList, getPermissionsMap };
  }
});

// src/permission-edit/permission-provider.js
var require_permission_provider = __commonJS({
  "src/permission-edit/permission-provider.js"(exports2, module2) {
    var { getPermissionsList, getPermissionsMap } = require_permission_list();
    var { getNonce: getNonce2, setOnDidChangeVisibility: setOnDidChangeVisibility2 } = (init_webview_validator(), __toCommonJS(webview_validator_exports));
    var commands = {
      add: "addPermission",
      remove: "removePermission"
    };
    var PermissionProvider = class {
      ...
      updateWebview() {
        this.manifestService.readPermissions().then((permissions) => this._view.webview.html = this.getWebviewContent(permissions));
      }
    ...
    module2.exports = PermissionProvider;
  }
});
...
// src/dependency-edit/pubspec-manager.js
var require_pubspec_manager = __commonJS({
  "src/dependency-edit/pubspec-manager.js"(exports2, module2) {
    var vscode2 = require("vscode");
    var yaml = require_dist();
    var { pubspecPath } = require_path_provider();
    var PubspecManager = class {
      async readPubspec() {
        if (!pubspecPath()) {
          return null;
        }
        try {
          const decoder = new TextDecoder("utf-8");
          const uint8Content = await vscode2.workspace.fs.readFile(vscode2.Uri.file(pubspecPath()));
          return yaml.parse(decoder.decode(uint8Content));
        } catch (error) {
          vscode2.window.showInformationMessage("Pubspec error: " + error + "\n");
        }
      }
    ...
    module2.exports = PubspecManager;
  }
});

// src/widget-list/kinds.js
var require_kinds = __commonJS({
  "src/widget-list/kinds.js"(exports2, module2) {
    var Kind = {
      boolean: "BOOL",
      Double: "DOUBLE",
      Enum: "ENUM",
    ...
    module2.exports = { Kind };
  }
});

// src/widget-edit/widget-field-html.js
var require_widget_field_html = __commonJS({
  "src/widget-edit/widget-field-html.js"(exports2, module2) {
    var vscode2 = require("vscode");
    var { Kind } = require_kinds();
    var { getNonce: getNonce2 } = (init_webview_validator(), __toCommonJS(webview_validator_exports));
    function getHtml() {
      return `<!DOCTYPE html>
    <html lang="en">
    ...
    function getWebviewContent(widgetInfo, webview, extensionUri) {
      if (!widgetInfo.result) {
        vscode2.window.showWarningMessage("Cannot read widget properties.");
        return;
      }
      const nonce = getNonce2();
      const styleUri = webview.asWebviewUri(vscode2.Uri.joinPath(extensionUri, "media", "styles.css"));
      const scriptUri = webview.asWebviewUri(vscode2.Uri.joinPath(extensionUri, "media", "scripts.js"));
      widgetInfo.result.properties.sort((a, b) => {
        const nameA = a?.name || "";
        const nameB = b?.name || "";
        return nameA > nameB ? 1 : nameB > nameA ? -1 : 0;
      });
      const tableRows = widgetInfo.result.properties.map((property) => {
        if (property.type) {
          return ` <tr>
                <td>${property.name}</td>
    ...
    function generateInputField(property) {
      ...
      const isDefault = property.defvalue !== void 0 && property.defvalue !== null;
...
// src/widget-edit/widget-field-provider.js
var require_widget_field_provider = __commonJS({
  "src/widget-edit/widget-field-provider.js"(exports2, module2) {
    var vscode2 = require("vscode");
    var DartAnalyzer2 = require_dart_analyzer();
    var { getHtml, getWebviewContent } = require_widget_field_html();
    var commands = {
    ...
    var WidgetFieldProvider = class _WidgetFieldProvider {
      ...
      static getInstance(extensionUri) {
        if (!this.instance) {
          this.instance = new _WidgetFieldProvider(extensionUri);
        }
        const config = vscode2.workspace.getConfiguration("widgetedit");
        ...
        webviewView.webview.onDidReceiveMessage(async (message) => {
          switch (message.command) {
            ...
            case commands.moveToWidget:
              ...
              break;
            default:
              vscode2.window.showErrorMessage("Error: " + message.newValue);
              break;
          }
        });
      }
      updateWebview(widgetInfo) {
        if (!widgetInfo || !this._view) {
          return;
        }
      ...
      async updateWidgetProperty(message) {
        ...
        const widgetCode = vscode2.window.activeTextEditor?.document;
        if (!widgetCode) {
          return;
        }
        ...
        if (this.isAutosave) {
          ...
          DartAnalyzer2.getInstance().updateContent(
            widgetCode.uri.fsPath,
            vscode2.window.activeTextEditor?.document.getText()
          );
        }
        this.isUpdatingProperty = false;
      }
      ...
      async getWidgetConstructorRange() {
        const document = vscode2.window.activeTextEditor?.document;
        if (!document || !this.widgetInfo?.offset) {
          return null;
        }
        ...
        while (currentPosition < document.getText().length) {
          ...
          if (char === "(") {
            ...
            parenDepth--;
            if (parenDepth === 0) {
              return new vscode2.Range(startPosition, document.positionAt(currentPosition + 1));
            }
          }
          currentPosition++;
        }
  ...
  ${indentation}${property} : ${value},${widgetText.slice(position)}`;
      ...
      findFirstOccurrenceFromOffset(searchText, offset) {
        ...
        if (indexInSubstring === -1) {
          vscode2.window.showInformationMessage(`Text "${searchText}" not found from offset ${offset}.`);
          return;
        }
      ...
      moveCursorToPosition(editor, document, positionInDocument, text, widgetName) {
        ...
        if (widgetNameIndex !== -1) {
          ...
          vscode2.commands.executeCommand("workbench.action.focusActiveEditorGroup");
        }
      }
      async getSuggestions(message) {
        ...
        if (editor) {
          ...
          const document = editor.document;
          const completionList = await vscode2.commands.executeCommand(
          ...
          const suggestions = completionList["items"].filter((item) => {
    ...
    module2.exports = WidgetFieldProvider;
  }
});

// src/utils/custom-widget-finder.js
var require_custom_widget_finder = __commonJS({
  "src/utils/custom-widget-finder.js"(exports2, module2) {
    var vscode2 = require("vscode");
    var { libPath } = require_path_provider();
    function extractConstructorParams(content, widgetName) {
      ...
      const processedParams = /* @__PURE__ */ new Set();
      let paramMatch;
      while ((paramMatch = paramRegex.exec(match[1])) !== null) {
        const [
          superKeyParam,
          superKeyDefaultValue,
          typeParam,
          nameParam,
          typeDefaultValue,
          thisParam,
        ...
        if (superKeyParam) {
          ...
          param = {
            name: thisParam,
            type: "dynamic",
            // We'll try to infer the type from class field declarations
    ...
    function generateWidgetTemplate(widgetName, params) {
      ...
      const paramStrings = requiredParams.map((param) => {
        const defaultValue = param.type.includes("String") ? '""' : param.type.includes("RxString") ? '"".obs' : param.type.includes("bool") ? "false" : param.type.includes("RxBool") ? "false.obs" : param.type.includes("int") ? "0" : param.type.includes("double") ? "0.0" : param.type.includes("List") ? "[]" : param.type.includes("Map") ? "{}" : param.type.includes("Widget") ? "const SizedBox()" : param.type.includes("VoidCallback") ? "() {}" : "null";
        return `
    ...
    async function findCustomWidgetFiles() {
      if (!libPath()) {
        if (vscode2.workspace.workspaceFolders?.length > 0) {
          vscode2.window.showInformationMessage("No pubspec.yaml or lib folder found");
        } else {
          vscode2.window.showInformationMessage("No workspace folder opened");
        }
        return [];
      }
      const customWidgets = [];
      const globPattern = new vscode2.RelativePattern(libPath(), "**/*.dart");
      const dartFiles = await vscode2.workspace.findFiles(globPattern);
        ...
        try {
          ...
          while ((match = customWidgetRegex.exec(content)) !== null) {
            ...
            customWidgets.push({
              name: widgetName,
              icon: "\u2726",
              // Custom icon for custom widgets
              template
            });
          }
        } catch (error) {
    ...
    module2.exports = findCustomWidgetFiles;
  }
});

// src/utils/widget-list.js
var require_widget_list = __commonJS({
  "src/utils/widget-list.js"(exports2, module2) {
    var findCustomWidgetFiles = require_custom_widget_finder();
    var vscode2 = require("vscode");
    var additionalWidgets = [
      ...
      { name: "CustomPaint", icon: "\u{1F3A8}", template: "CustomPaint(\n	painter: MyPainter(),\n	 child: \n)," },
      ...
      { name: "Listener", icon: "\u{1F442}", template: "Listener(\n	onPointerDown: (event) {\n}, \n	child: \n)," },
      ...
      { name: "TimePicker", icon: "\u{1F552}", template: "showTimePicker(\n	context: context, \n	initialTime: TimeOfDay.now())," },
      { name: "DatePicker", icon: "\u{1F4C5}", template: "showDatePicker(\n	context: context,\n	 initialDate: DateTime.now(),\n	 firstDate: DateTime(2000), \n	lastDate: DateTime(2100)\n)," },
      ...
      { name: "Visibility", icon: "\u{1F441}", template: "Visibility(\n	visible: true, \n	child: )," },
      { name: "Builder", icon: "\u{1F3D7}", template: "Builder(\n	builder: (BuildContext context) { \n	return Container(); })," },
      { name: "LayoutBuilder", icon: "\u{1F4D0}", template: "LayoutBuilder(\n	builder: (BuildContext context,\n	BoxConstraints constraints) { \n	return Container(); \n})," }
    ];
    async function getFlutterWidgetsList() {
      try {
        ...
        vscode2.window.showErrorMessage("Failed to find custom widgets");
      }
    }
    var flutterWidgets = [
      ...
      { name: "Image", icon: "\u{1F5BC}", template: "Image.asset('asset_name')," },
      ...
      { name: "GestureDetector", icon: "\u{1F446}", template: "GestureDetector(onTap: () {\n	}, child: )," },
    ...
    module2.exports = { flutterWidgets, getFlutterWidgetsList };
  }
});

// src/widget-list/widget-list-provider.js
var require_widget_list_provider = __commonJS({
  "src/widget-list/widget-list-provider.js"(exports2, module2) {
    var vscode2 = require("vscode");
    var { getNonce: getNonce2, setOnDidChangeVisibility: setOnDidChangeVisibility2 } = (init_webview_validator(), __toCommonJS(webview_validator_exports));
    var { getFlutterWidgetsList } = require_widget_list();
    var WidgetListProvider = class {
      constructor(extensionUri) {
      ...
      async _getHtmlContent(webview) {
        const nonce = getNonce2();
        const styleUri = webview.asWebviewUri(vscode2.Uri.joinPath(this._extensionUri, "media", "styles.css"));
        const scriptUri = webview.asWebviewUri(vscode2.Uri.joinPath(this._extensionUri, "media", "script_list.js"));
    ...
    module2.exports = WidgetListProvider;
  }
});

// src/providers-manager.js
var require_providers_manager = __commonJS({
  "src/providers-manager.js"(exports2, module2) {
    var vscode2 = require("vscode");
    var DependencyProvider = require_dependency_provider();
    var DependencyService = require_dependency_service();
    var ManifestService = require_manifest_service();
    var PermissionProvider = require_permission_provider();
    var PubspecManager = require_pubspec_manager();
    var WidgetFieldProvider = require_widget_field_provider();
    var WidgetListProvider = require_widget_list_provider();
    var ProvidersManager2 = class {
      constructor(context) {
      ...
      registerProviders() {
        this._context.subscriptions.push(
          vscode2.window.registerWebviewViewProvider("flutter-widget-list-activitybar", this.widgetListProvider),
          vscode2.window.registerWebviewViewProvider("widget-fields-sidebar-activitybar", this.widgetFieldProvider),
          vscode2.window.registerWebviewViewProvider("flutter-dependencies-activitybar", this.dependencyProvider),
          vscode2.window.registerWebviewViewProvider("flutter-permissions-activitybar", this.permissionProvider),
          vscode2.window.registerWebviewViewProvider("flutter-widget-list-explorer", this.widgetListProvider),
          vscode2.window.registerWebviewViewProvider("widget-fields-sidebar-explorer", this.widgetFieldProvider),
          vscode2.window.registerWebviewViewProvider("flutter-dependencies-explorer", this.dependencyProvider),
          vscode2.window.registerWebviewViewProvider("flutter-permissions-explorer", this.permissionProvider)
        );
      }
    ...
    module2.exports = ProvidersManager2;
  }
});

// src/handlers/widget-info-handler.js
var require_widget_info_handler = __commonJS({
  "src/handlers/widget-info-handler.js"(exports2, module2) {
    var DartAnalyzer2 = require_dart_analyzer();
    var FileAnalyzer = require_file_analyzer();
    var vscode2 = require("vscode");
    var {
      serverNotStartedMessage,
      fileNotAnalyzed
    } = require_dart_analysis_server();
    var WidgetInfoHandler = class {
      static async getWidgetDescription(filePath, line, column) {
        ...
        try {
          const dartAnalyzer = DartAnalyzer2.getInstance().analysisServer;
      ...
      static async getHoverInfo(document, position) {
        const hoverResponse = await vscode2.commands.executeCommand("vscode.executeHoverProvider", document.uri, position);
        if (Array.isArray(hoverResponse)) {
          if (!hoverResponse?.length) {
            return null;
          }
          ...
          for (const hoverItem of hoverResponse) {
            for (const content of hoverItem.contents) {
              const dartString = content instanceof vscode2.MarkdownString ? content.value : typeof content === "string" ? content : null;
              if (dartString) {
      ...
      static getOffset(line, column) {
        const fileContent = vscode2.window.activeTextEditor?.document?.getText();
        if (!fileContent) {
          return;
        }
      ...
      static async analyzerServerNotStartedHandler() {
        try {
          if (!DartAnalyzer2.serverMustStop) {
            const dartAnalyzer = DartAnalyzer2.getInstance();
            dartAnalyzer.start();
          }
        } catch (error) {
      ...
      static async fileNotAnalyzedHandler(filePath) {
        try {
          ...
          DartAnalyzer2.serverMustStop ? fileAnalyzer.rejectFile(filePath) : await fileAnalyzer.analyzeFile(filePath);
        } catch (error) {
          console.error("Cant start server: ", error);
        }
      }
    };
    module2.exports = WidgetInfoHandler;
  }
});

// src/handlers/document-save-handler.js
var require_document_save_handler = __commonJS({
  "src/handlers/document-save-handler.js"(exports2, module2) {
    var DartAnalyzer2 = require_dart_analyzer();
    var DocumentSaveHandler = class {
      static async onDocumentSave(document) {
        const dartAnalyzer = DartAnalyzer2.getInstance();
        dartAnalyzer.updateContent(document.uri.fsPath, document.getText());
      }
    };
    module2.exports = DocumentSaveHandler;
  }
});

// src/event-manager.js
var require_event_manager = __commonJS({
  "src/event-manager.js"(exports2, module2) {
    var WidgetFieldProvider = require_widget_field_provider();
    var WidgetInfoHandler = require_widget_info_handler();
    var DocumentSaveHandler = require_document_save_handler();
    var DartAnalyzer2 = require_dart_analyzer();
    var vscode2 = require("vscode");
    var EventManager2 = class {
      constructor(context, dartAnalysisServer2, providersManager) {
        this.context = context;
        this.dartAnalysisServer = dartAnalysisServer2;
      ...
      _registerEditorChangeListener() {
        const disposable = vscode2.window.onDidChangeActiveTextEditor(async (editor) => {
          if (editor) {
            const dartAnalyzer = DartAnalyzer2.getInstance();
            if (DartAnalyzer2.serverMustStop) {
      ...
      _registerTextSelectionChangeListener() {
        const disposable = vscode2.window.onDidChangeTextEditorSelection(async (event) => {
      ...
      _registerSaveDocumentListener() {
        const disposable = vscode2.workspace.onDidSaveTextDocument(async (document) => {
    ...
    module2.exports = EventManager2;
  }
});

// src/main.js
var DartAnalyzer = require_dart_analyzer();
var CommandManager = require_command_manager();
var ProvidersManager = require_providers_manager();
var EventManager = require_event_manager();
var { findPaths } = require_path_provider();
var vscode = require("vscode");
var dartAnalysisServer;
async function activate(context) {
  console.log(
    "Visual Flutter extension is activated (workspace: " + vscode.workspace.name + ")"
  );
  await findPaths();
